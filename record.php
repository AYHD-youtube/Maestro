    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="breadcrumb-hero">
        <div class="container">
          <div class="breadcrumb-hero">
            <h2>Record</h2>
            <p>Click on Record button to start recording.</p>
          </div>
        </div>
      </div>
...
if(isset($_SESSION["username"]))
{
      echo "<iframe src='record.html' title='Guitar' width='100%' height='500px' data-aos='fade-up'>
                  </iframe>";
                  echo "<iframe src='Piano/recordp.html' title='Guitar' width='100%' height='500px' data-aos='fade-up'>
                              </iframe>";
            }
else {
      echo"<center><h1>Please Login Yo Use This Feature</h1></center>";
}
?>
